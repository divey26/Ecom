        ...
        <div style={{ display: 'flex', paddingRight: '90px' }}>
                  ...
                  >
                    ...
                    <div style={{ textAlign: 'right' }}>
                      <InputNumber
                        ...
                        } // Directly calling updateQuantity
          ...
          {cart.length === 0 ? (
            ...
            >
              ...
              <div style={{ marginBottom: '20px' }}>
                <span
                  style={{ float: 'right', color: 'green', fontSize: '15px' }}
                >
                  $
                  {cart
                    .reduce(
              ...
              <div style={{ marginBottom: '10px' }}>
                <Text
                  style={{ float: 'left', fontSize: '16px', color: 'black' }}
                >
                  <strong>Taxes</strong>
                </Text>
                <span
                  style={{ float: 'right', color: 'grey', fontSize: '16px' }}
                >
                ...
                {deadline && (
                  <div style={{ marginBottom: '10px' }}>
                    <Text>
                      <strong>Flash Offer Increase (12%)</strong>
                    </Text>
                    <span style={{ float: 'right', color: 'red' }}>
                      {' '}
                      -${flashOfferIncrease.toFixed(2)}
                    </span>
                  </div>
                )}
              </div>
              ...
              >
                ...
                <span
                  style={{ float: 'right', color: 'green', fontSize: '18px' }}
                >
                  ${newTotal}
                </span>
              </div>
